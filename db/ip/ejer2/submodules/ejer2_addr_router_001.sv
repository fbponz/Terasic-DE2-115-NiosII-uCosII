...
(
    ...
    localparam PAD10 = log2ceil(64'h10000108 - 64'h10000100); 
    localparam PAD11 = log2ceil(64'h10000110 - 64'h10000108); 
    ...
    localparam PAD16 = log2ceil(64'h10002080 - 64'h10002040); 
    localparam PAD17 = log2ceil(64'h10003010 - 64'h10003000); 
    localparam PAD18 = log2ceil(64'h10003050 - 64'h10003040); 
    ...
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 29'h10000108   ) begin
    ...
    if ( {address[RG:PAD16],{PAD16{1'b0}}} == 29'h10002040   ) begin
            src_channel = 20'b00000000000010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x10003000 .. 0x10003010 )
    if ( {address[RG:PAD17],{PAD17{1'b0}}} == 29'h10003000   ) begin
            src_channel = 20'b01000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x10003040 .. 0x10003050 )
    if ( {address[RG:PAD18],{PAD18{1'b0}}} == 29'h10003040   ) begin
